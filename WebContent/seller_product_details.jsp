				...
				<div class="row clearfix">
					<div class="col-lg-3 col-sm-6 col-md-3">
							...
							<div class="bts bts-red">
								...
								<a href="seller_edit_product.jsp?proid=<%=pro.getId()%>">
								  <input type="button" name="action" value="EDIT" class="btn btn-red">
								</a>
								<a href="seller_delete_product.jsp?proid=<%=pro.getId()%>">
								  <input type="button" name="action" value="DELETE" class="btn btn-red">
								</a>
