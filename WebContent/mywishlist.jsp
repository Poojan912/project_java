	...
	<div class="page-content-product">
		<div class="main-product">
			<div class="container">
				...
				<h2 align="center" style="color: white;">My Wishlist</h2>
				<br>
				<br>
				<%
                ...
                <%  
                   ...
                   {
               %>
                   	   <h2 align="center" style="color: red;">THERE IS NO ITEM IN YOUR WISHLIST</h2>
               <%
				...
				<div class="row clearfix">
                    ...
                    for(wishlist w:list)
                    {
                    	product pro=product_dao.getproductbyid(w.getProid());
                 %>
