...
public class Services {
	...
	public static void sendMail(String emailid,int value){
		final String username  = "blacktiger554433@gmail.com";//Sender Email
		final String password   = "black@554433";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "blacktiger554433@gmail.com";
		final String password   = "black@554433";
